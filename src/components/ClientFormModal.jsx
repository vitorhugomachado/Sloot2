...
const ClientFormModal = ({ open, mode = 'create', initialData, onClose, onSubmit }) => {
  ...
  const addTag = () => {
    ...
    handleField('tags', [...form.tags, trimmed]);
    setTagInput('');
  };

  const removeTag = (tag) => handleField('tags', form.tags.filter((t) => t !== tag));
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px', marginBottom: '6px' }}>
              {form.tags.map((tag) => (
                <span
                  ...
                  style={{
                    padding: '4px 10px',
                    background: 'var(--brand-200, rgba(0,0,0,0.05))',
                    borderRadius: '14px',
                    fontSize: '0.78rem',
                    fontWeight: 500,
                    display: 'inline-flex',
            ...
            <div style={{ display: 'flex', gap: '8px' }}>
              <input
                ...
                placeholder="VIP, fidelidade, premium..."
              />
              <button
                type="button"
                onClick={addTag}
