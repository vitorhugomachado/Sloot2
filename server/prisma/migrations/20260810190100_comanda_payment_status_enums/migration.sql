-- Índices parciais (text) — remover antes de enums
...
-- Recriar índice parcial com tipo enum
...
-- ComandaPayment (1 linha por pagamento registrado)
...
-- Backfill a partir de movimentos COMANDA existentes
